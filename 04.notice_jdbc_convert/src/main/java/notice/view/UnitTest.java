...
public class UnitTest {
	...
	public static void main(String[] args) throws SQLException {
		...
		System.out.println(context.getBean("factoryDao2", FactoryDao.class));
		System.out.println(context.getBean("factoryDao3", FactoryDao.class));
		System.out.println(context.getBean("factoryDao4", FactoryDao.class));
